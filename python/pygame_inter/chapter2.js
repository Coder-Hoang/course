...
function one_wrong() {
  one_answerText.textContent = 'Wrong! The Correct Answer is B';
}
...
one_buttons.forEach(one_button => {
  one_button.addEventListener('click', function() {
    ...
    if (one_button.value === 'one-B') {
      one_correct();
      one_button.style.backgroundColor = 'green'
    } if (one_button.value === 'one-A' || one_button.value === 'one-C' || one_button.value === 'one-D') {
      one_wrong();
...
function two_wrong() {
  two_answerText.textContent = 'Wrong! The Correct Answer is D';
}
...
two_buttons.forEach(two_button => {
  two_button.addEventListener('click', function() {
    ...
    if (two_button.value === 'two-D') {
      two_correct();
      two_button.style.backgroundColor = 'green'
    } if (two_button.value === 'two-C' || two_button.value === 'two-B' || two_button.value === 'two-A') {
      two_wrong();
...
three_buttons.forEach(three_button => {
  three_button.addEventListener('click', function() {
    ...
    } if (three_button.value === 'three-C' || three_button.value === 'three-B' || three_button.value === 'three-D') {
      three_wrong();
